...
!==================== 3. BCC {110}<111> ====================
     ...
     & /), (/12,12/) )
      ...
      elseif (typeCry .eq. 3 .and. numSys .eq. 24) then

! ----------- 1~12 vs 1~12  (Figure a) -----------------
         ih(1:12,1:12) = reshape( (/ 
     & 1,2,3,3,5,4,5,6,6,5,5,4,
     & 2,1,3,3,6,5,4,5,5,4,6,5,
     & 3,3,1,2,4,5,6,5,4,5,5,6,
     ...
     & 5,4,5,6,5,6,4,5,2,1,3,3,
     & 5,6,5,4,6,5,5,4,3,3,1,2,
     & 4,5,6,5,5,4,6,5,3,3,2,1 /), (/12,12/) )

! ----------- 1~12 vs 13~24  (Figure b) -----------------
         ih(1:12,13:24) = reshape( (/ 
     & 9,9,8,7,11,13,10,12,10,12,13,11,
     & 9,9,7,8,10,12,11,13,11,13,12,10,
     & 7,8,9,9,13,11,12,10,13,11,10,12,
     & 8,7,9,9,12,10,13,11,12,10,11,13,
     & 10,12,13,11,9,9,8,7,11,13,10,12,
     & 11,13,12,10,9,9,7,8,10,12,11,13,
     & 13,11,10,12,7,8,9,9,13,11,12,10,
     & 12,10,11,13,8,7,9,9,12,10,13,11,
     & 10,12,11,13,11,13,12,10,9,9,7,8,
     & 11,13,10,12,10,12,13,11,9,9,8,7,
     & 12,10,13,11,12,10,11,13,8,7,9,9,
     & 13,11,12,10,13,11,10,12,7,8,9,9 /), (/12,12/) )

! ----------- symmetry: 13~24 vs 1~12 -------------------
         ih(13:24,1:12) = transpose( ih(1:12,13:24) )

! ----------- 13~24 vs 13~24  (Figure c) ----------------
         ih(13:24,13:24) = reshape( (/ 
     & 1,14,15,15,17,16,16,4,17,16,4,16,
     & 14,1,15,15,16,4,17,16,16,4,16,17,
     & 15,15,1,14,4,16,16,17,16,17,16,4,
     & 15,15,14,1,16,17,4,16,4,16,17,16,
     & 17,16,4,16,1,14,15,15,17,16,16,4,
     & 16,4,16,17,14,1,15,15,16,4,17,16,
     & 16,17,16,4,15,15,1,14,4,16,16,17,
     & 4,16,17,16,15,15,14,1,16,17,4,16,
     & 17,16,16,4,17,16,4,16,1,14,15,15,
     & 16,4,17,16,16,4,16,17,14,1,15,15,
     & 4,16,16,17,16,17,16,4,15,15,1,14,
     & 16,17,4,16,4,16,17,16,15,15,14,1 /), (/12,12/) )
